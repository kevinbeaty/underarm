...
module.exports = function(_r){
  ...
  var value = _r.value = dispatcher(),
      ...
      _reduce = require('transduce/base/reduce'),
      _unreduced = require('transduce/base/unreduced'),
      transduce = _r.transduce = dispatcher(),
      _transduce = require('transduce/base/transduce'),
      ...
      _toArray = require('transduce/base/toArray'),
      iteratee = _r.iteratee = dispatcher()
  _r.resolveSingleValue = resolveSingleValue
  _r.resolveMultipleValues = resolveMultipleValues
  _r.reduced = require('transduce/base/reduced')
  _r.isReduced = require('transduce/base/isReduced')
  _r.foldl = reduce
  _r.inject = reduce
  _r.deref = unwrap
  _r.conj = append
  ...
  var compose = _r.compose = require('transduce/base/compose')
