...
var util = require(29),
    ...
    reduced = require(28),
    iter = require(15),
    transformer = require(30);

module.exports = {
  reduce: require(33),
  transduce: require(38),
  into: require(23),
  toArray: require(37),
  map: require(24),
  filter: require(21),
  remove: require(34),
  take: require(35),
  takeWhile: require(36),
  drop: require(19),
  dropWhile: require(20),
  cat: require(18),
  mapcat: require(25),
  partitionAll: require(31),
  partitionBy: require(32),
  compose: compose,
